# File contains classes/models/forms for all Rango apps.
...
class PageForm(forms.ModelForm):
    title = forms.CharField(max_length=128, help_text="Please\
        enter the title of the page.")
    url = forms.URLField(max_length=200, help_text="Please\
